...
@Component({
  selector: 'app-dlmt-details-adp',
  templateUrl: './dlmt-details-adp.component.html',
  styleUrls: ['./dlmt-details-adp.component.css']
})

export class DlmtDetailsAdpComponent implements OnInit, OnDestroy {
