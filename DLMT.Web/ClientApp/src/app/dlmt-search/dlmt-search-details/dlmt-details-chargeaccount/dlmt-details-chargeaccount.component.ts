...
@Component({
  selector: 'app-dlmt-details-chargeaccount',
  templateUrl: './dlmt-details-chargeaccount.component.html',
  styleUrls: ['./dlmt-details-chargeaccount.component.css']
})



export class DlmtDetailsChargeaccountComponent implements OnInit, OnDestroy {
