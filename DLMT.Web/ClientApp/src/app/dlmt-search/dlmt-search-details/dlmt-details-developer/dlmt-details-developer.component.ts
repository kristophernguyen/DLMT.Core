...
import { DlmtCaseClient, CasePhaseDTO, DeveloperDTO, ContactClient, ContactGetAllRequest } from 'src/app/services/apis/dlmt-api';
...
export class DlmtDetailsDeveloperComponent implements OnInit, OnDestroy {
