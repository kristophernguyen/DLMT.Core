...
@Component({
  selector: 'app-plancheck-document-view',
  templateUrl: './plancheck-document-view.component.html',
  styleUrls: ['./plancheck-document-view.component.css']
})


export class PlancheckDocumentViewComponent implements OnInit, OnDestroy {
