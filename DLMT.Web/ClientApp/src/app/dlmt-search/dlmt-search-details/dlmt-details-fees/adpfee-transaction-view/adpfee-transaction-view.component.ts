...
@Component({
  selector: 'app-adpfee-transaction-view',
  templateUrl: './adpfee-transaction-view.component.html',
  styleUrls: ['./adpfee-transaction-view.component.css']
})
export class AdpfeeTransactionViewComponent implements OnInit, OnDestroy {
