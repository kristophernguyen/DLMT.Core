...
@Component({
  selector: 'app-dlmt-details-plotting',
  templateUrl: './dlmt-details-plotting.component.html',
  styleUrls: ['./dlmt-details-plotting.component.css']
})



export class DlmtDetailsPlottingComponent implements OnInit, OnDestroy {
