...
@Component({
  selector: 'app-dlmt-details-tentativereview-view',
  templateUrl: './dlmt-details-tentativereview-view.component.html',
  styleUrls: ['./dlmt-details-tentativereview-view.component.css']
})


export class DlmtDetailsTentativereviewViewComponent implements OnInit, OnDestroy {
